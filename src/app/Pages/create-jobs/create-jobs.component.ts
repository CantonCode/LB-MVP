...
export class CreateJobsComponent implements OnInit {
    ...
    switch (card) {
      ...
      case 'description':
        ...
        if (
          ...
          this.onlySpaces(this.jobDescription)
        ) {
          console.log('INVALID');
          return false;
        }
      ...
      case 'location':
        ...
        this.jobLocationFull =
          this.jobLocationTown +
          ', ' +
          this.jobLocationCounty +
          ', ' +
  ...
  submitJob() {
    ...
    this.finalJob = new Job(
      this.jobName,
      this.jobDescription,
      [this.jobCat1, this.jobCat2],
    ...
    this.http
      .post<Job>(
        'https://shrouded-reef-89389.herokuapp.com/api/jobs/',
        this.finalJob,
        { observe: 'response' }
      )
      .subscribe({
